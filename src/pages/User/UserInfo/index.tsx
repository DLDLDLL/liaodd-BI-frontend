// import { selectAvatarUrl } from '@/constants';
import { hasRemainFrequencyUsingGet } from '@/services/liaodd/aiFrequencyController';
import { addOrderUsingPost } from '@/services/liaodd/aiFrequencyOrderController';
import {
    getLoginUserUsingGet,
    getUserVoByIdUsingGet,
    updateByProfileUserUsingPost,
    updateMyUserUsingPost,
} from '@/services/liaodd/userController';
...
const UserInfo: React.FC = () => {
    ...
    const loadData = async () => {
        try {
            const res = await hasRemainFrequencyUsingGet();
        ...
        <>
            ...
            <ModalForm<API.UserUpdateMyRequest>
                ...
                onFinish={async (values) => {
                    await waitTime(1000);
                    //点击发起请求
                    const isModify = await updateByProfileUserUsingPost(values);
                    if (isModify) {
